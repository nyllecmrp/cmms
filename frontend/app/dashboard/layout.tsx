...
export default function DashboardLayout({
  ...
  const navigation = [
    ...
    { name: 'Preventive Maintenance', href: '/dashboard/preventive-maintenance', icon: '🔄', locked: true, moduleCode: 'preventive_maintenance', moduleKey: 'preventive-maintenance' },
    { name: 'Procurement', href: '/dashboard/procurement', icon: '🛒', locked: true, moduleCode: 'purchasing_procurement', moduleKey: 'procurement' },
