...
async function seedPurchaseOrders() {
  ...
  try {
    ...
    if (!org || org.length === 0 || !user || user.length === 0) {
      console.error('❌ No organization or user found. Please create an account first.');
      process.exit(1);
    }
    ...
    console.log(`📦 Creating sample Purchase Orders for organization: ${organizationId}`);
    ...
    console.log('\n✅ Successfully created 5 sample Purchase Orders!');
    console.log('\nPO Status Summary:');
