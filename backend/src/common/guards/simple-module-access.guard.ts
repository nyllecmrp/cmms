...
/**
 * Simple Module Access Guard - Only checks role-based permissions
 * Does NOT check database licenses (to avoid circular dependencies)
 * Use this guard for basic module access control
 */
@Injectable()
export class SimpleModuleAccessGuard implements CanActivate {
